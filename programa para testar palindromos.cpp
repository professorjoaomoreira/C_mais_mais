...
/*Faça um programa onde o usuário digite uma palavra ou frase e o programa informe se é um palíndromo.
Exemplo (ana, arara, ovo). O usuário poderá repetir o procedimento quantas vezes quiser.*/
